...
//                    .WithAll<MultiFontBlobReferences, MultiFontMaterialRef, BackEndMesh>()
//                    .Build(EntityManager);
...
//            var multiFontMaterials = SystemAPI.GetBuffer<MultiFontMaterialRef>(fontBlobReferenceEntity).ToNativeArray(WorldUpdateAllocator);
