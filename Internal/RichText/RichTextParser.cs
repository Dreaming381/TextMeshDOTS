...
namespace TextMeshDOTS.RichText
{
    public static class RichTextParser
    {
            ...
            ref TextConfiguration textConfiguration)  //this is just a cache to avoid allocation
        {
            ...
            if (textConfiguration.m_tagNoParsing && (firstTagIndentifier.nameHashCode != 53822163 && firstTagIndentifier.nameHashCode != 49429939))
                return false;
            else if (firstTagIndentifier.nameHashCode == 53822163 || firstTagIndentifier.nameHashCode == 49429939)
            {
                textConfiguration.m_tagNoParsing = false;
                return true;
            }
            ...
            else
            {
                ...
                switch (firstTagIndentifier.nameHashCode)
                {
                    ...
                    case 66:  // <B>
                        ...
                        desiredFontAssetRef = new FontAssetRef(textConfiguration.m_fontFamilyHash, textConfiguration.m_fontStyleInternal);
                        fontIndex = TextHelper.GetFontIndex(fontAssetArray, desiredFontAssetRef);
                        if (fontIndex != -1)
                    ...
                    case 28511:  // <FONT>
                        ...
                        desiredFontAssetRef = new FontAssetRef(desiredFontFamilyHash, textConfiguration.m_fontStyleInternal);
                        fontIndex = TextHelper.GetFontIndex(fontAssetArray, desiredFontAssetRef);
                    ...
                    case 1441524:  // <INDENT>
                        ...
                        textConfiguration.m_indentStack.Add(textConfiguration.m_tagIndent);


                        textConfiguration.m_xAdvance = textConfiguration.m_tagIndent;
                        return true;
                    case 7598483:  // </indent>
                    case 6971027:  // </INDENT>
                        textConfiguration.m_tagIndent = textConfiguration.m_indentStack.RemoveExceptRoot();
                    ...
                    case -842656867:  // <LINE-INDENT>
                        ...
                        textConfiguration.m_xAdvance += textConfiguration.m_tagLineIndent;
                        return true;
                    case -445537194:  // </line-indent>
                    case 1897386838:  // </LINE-INDENT>
                        textConfiguration.m_tagLineIndent = 0;
                        return true;
                    ...
                    case 10723418:  // <NOPARSE>
                        textConfiguration.m_tagNoParsing = true;
                        return true;
                    //case 1913798: // <action>
                    //case 1286342: // <ACTION>
